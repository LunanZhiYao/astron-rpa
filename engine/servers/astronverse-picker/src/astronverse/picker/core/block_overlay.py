...
class BlockOverlay:
    ...
    def _find_rpa_window_rects(self) -> list[tuple]:
        """
        查找所有"罗文RPA"相关窗口的屏幕矩形。

        策略:
        1. 枚举所有可见顶层窗口
        2. 找到标题包含"罗文RPA"的窗口，记录其进程 ID
